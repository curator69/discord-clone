    ...
    <div className={classes.main}>
      <div className={classes.item1}>
        ...
        <div className={classes.location}>
          <img src={flag} alt="USA flag" className={classes.flag} />
          <p className={classes.flagText}>English, USA</p>
        </div>
      ...
      <div className={classes.item7}>
        <a className={classes.signup_btn}>Sign up</a>
      </div>
    </div>
  );
};
